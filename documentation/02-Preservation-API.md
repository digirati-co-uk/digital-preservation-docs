...
GET    /deposits/{depositId}/pipelinerunjobs => GetPipelineJobResults([FromRoute] string depositId)
GET    /deposits/{depositId}/pipelinerunjobs/{jobId} => GetPipelineJobResult([FromRoute] string depositId, string jobId)
-->
