- There is a preservation_target property of a deposit which can be applied at any time. And may have been automatically assigned and might not be editable for some users. It's the Fedora path this deposit will end up at.
