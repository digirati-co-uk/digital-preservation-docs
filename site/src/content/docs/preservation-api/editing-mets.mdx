...
Get the value from the Deposit's `metsETag` property, or from the `ETag` header of `GET {id}/mets`, and send it back **exactly as you received it**, quotation marks included — it is an S3 ETag, and the quotes are part of it:
