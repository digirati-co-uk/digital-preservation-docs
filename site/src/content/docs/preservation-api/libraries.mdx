...
rather than a description. A working Python METS parser already exists in the platform's own
iiif-builder service (`src/iiif-builder/app/mets_parser/`), which reads the same METS files this way.
