...
The `id` you give the job is yours - any unique URI will do, and it is echoed back on the result as `originalImportJob`. The API mints its own identifier for the job it actually runs.
