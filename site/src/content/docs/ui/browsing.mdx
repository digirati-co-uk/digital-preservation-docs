...
import imgBrowseArchivalGroup from '../../../assets/ui/browse-archival-group.jpg';
...
<Image src={imgBrowseArchivalGroup} alt="An Archival Group in Browse, showing the breadcrumb, its two versions, the deposits that made them, and the access and rights metadata inherited down the tree." />
