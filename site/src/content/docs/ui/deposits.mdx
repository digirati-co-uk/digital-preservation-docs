...
<Aside type="caution">
Because an inherited value is invisible at rest, a blank metadata cell does not mean "no value": it
means "nothing set *here*". Hover the row, or open the item, before concluding that something is
missing.
</Aside>
