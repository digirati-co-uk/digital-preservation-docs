...
import imgImportJobDiff from '../../../assets/ui/import-job-diff.jpg';
import imgImportJobResult from '../../../assets/ui/import-job-result.jpg';
...
<Image src={imgImportJobDiff} alt="A diff import job, listing the containers and binaries to add and leaving the patch, delete and rename sections empty." />
...
<Image src={imgImportJobResult} alt="A completed import job result, showing the new version v1 and the containers and binaries that were added." />
